...
int main() {
    ...
    Cube hallwayCube(4.0f, 2.0f, 10.0f);
    hallwayCube.uploadToGPU();
    hallwayCube.setFaceTexture(1, "../../images/425.jpg");
    hallwayCube.setFaceTexture(2, "../../images/425.jpg");
    hallwayCube.setFaceTexture(3, "../../images/425.jpg");
    hallwayCube.setFaceTexture(4, "../../images/wooden_floor.jpg");
    hallwayCube.setFaceTexture(5, "../../images/wooden_floor.jpg");

    Cube hallwayCube2(4.0f, 2.0f, 3.0f);
    hallwayCube2.uploadToGPU();
    hallwayCube2.setFaceTexture(0, "../../images/425.jpg");
    hallwayCube2.setFaceTexture(2, "../../images/425.jpg");
    hallwayCube2.setFaceTexture(4, "../../images/wooden_floor.jpg");
    hallwayCube2.setFaceTexture(5, "../../images/wooden_floor.jpg");

    Cube hallwayCube3(4.0f, 2.0f, 8.0f);
    hallwayCube3.uploadToGPU();
    hallwayCube3.setFaceTexture(0, "../../images/425.jpg");
    hallwayCube3.setFaceTexture(1, "../../images/425.jpg");
    hallwayCube3.setFaceTexture(3, "../../images/425.jpg");
    hallwayCube3.setFaceTexture(4, "../../images/wooden_floor.jpg");
    hallwayCube3.setFaceTexture(5, "../../images/wooden_floor.jpg");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        hallwayCube.render(cubePositions[0], shader);
        hallwayCube2.render(cubePositions[1], shader);
        hallwayCube3.render(cubePositions[2], shader);
